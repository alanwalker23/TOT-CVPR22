...
parser.add_argument('--epsilon', default=0.08, type=float, help="regularization parameter for optimal transport")
...
parser.add_argument('--num_videos', default=2, type=int, help="Number of videos in a batch")
parser.add_argument('--sigma', default=1.5, type=float, help="Number of videos in a batch")
...
parser.add_argument('--description', default = "bf_debug_4", help = "Description of model")
